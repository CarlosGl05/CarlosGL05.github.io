//http es un módulo que nos permite crear un servidor y manejar todas las solicitudes que le llegan
import http from 'http';
//Fs nos permite leer archivos de nuestro sistema
import fs from 'fs';
    ...
    function darBienvenida(req, res) {
      ...
      fs.readFile('bienvenida.html', 'utf8', (error, data) => {
        if (error) {
           //el 500 es un mensaje de error del servior, o sea, algo salió mal
          res.writeHead(500, { 'Content-Type': 'text/plain' });
          res.end('Oh no!!!!');
          return;
        }
        //200 es un mensaje que indica que todo salió bien
    ...
    function getUsuarios(req, res) {
        ...
        const usuarios = [
            {"nombre": "Punk","saldo": "0"},
            {"nombre": "Carlos","saldo": "1000000"}
        ];
      res.writeHead(200, { 'Content-Type': 'application/json' });
      
      //Escribe qué hace la función stringify y por qué la tenemos que usar
      //convierte un objeto de JS en una cadena de texto a formato JSON
